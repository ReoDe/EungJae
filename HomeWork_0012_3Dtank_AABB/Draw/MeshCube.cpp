...
MeshCube::MeshCube(Material * material, float width, float height, float depth, Texture* texture)
	: Mesh(material, texture), width(width), height(height), depth(depth), Min(0, 0, 0), Max(1, 1, 1)
{
